...
public class MainWindow extends JFrame {
	...
	private void showStyledAdminLogin() {
		...
		int result = JOptionPane.showConfirmDialog(this, panel, "Admin Authentication", JOptionPane.OK_CANCEL_OPTION,
		...
		if (result == JOptionPane.OK_OPTION) {
			...
			if ("admin".equalsIgnoreCase(username) && "admin123".equals(password)) {
				...
				JOptionPane.showMessageDialog(this, "❌ Invalid credentials! Try again.", "Login Failed",
